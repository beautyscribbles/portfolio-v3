...
projectInfo.set('bookmark', {
  ...
  source: {name: "m-oniqu3/bookmark-it", href:"https://github.com/m-oniqu3/bookmark-it"},
...
projectInfo.set('natura', {
  ...
  source: { name: "m-oniqu3/gym-natura", href: "https://github.com/m-oniqu3/gym-natura"},
...
projectInfo.set('movie-memory', {
  ...
  img: "/moviememory.png",
  stack: ["TypeScript", "SCSS" ,"Firebase", "The Movie Database API"],
  source: {
    name: "m-oniqu3/movie-memory", href: "https://github.com/m-oniqu3/movie-memory"
  },
  demo: {
    name: "movie-memory", href: "https://your-movie-memory.vercel.app/"
  },
...
projectInfo.set('finest-and-co', {
  ...
  source: {
    name: "m-oniqu3/finest-and-co", href: "https://github.com/m-oniqu3/finest-and-co"
  },
  demo: {
    name: "finest-and-co", href: "https://finest-co-furniture.vercel.app/"
  },
